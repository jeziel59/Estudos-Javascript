...
export default function initAnimaisFetch() {
  async function fetchAnimais(url) {
    //2 function que irá fazer o fetch, ativar a função de troca, e inserir no html
    try {
      ...
      animaisJson.forEach((animal) => {
        //6 para cada objeto dentro do json
  ...
  function createAnimal(animal) {
    //8 função que cria o html com as informações do json
